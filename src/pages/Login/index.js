  ...
  const handleSubmit = async () => {
    ...
    if (!userData) {
      ...
      localStorage.setItem(
        "authUser",
        JSON.stringify({ jwt: userData["jwt-token"], exp: Date.now() })
      );
      ...
      >
        ...
        <Grid item>
          <FormControl>
            ...
            />
            <FormHelperText
              id="senha_helper_text"
              sx={{ fontSize: 18, margin: "10px 0", color: "#f5f5f5" }}
            >
              Senha
            </FormHelperText>
          </FormControl>
